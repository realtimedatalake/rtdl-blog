...
draft: false
summary: "Guide to bulding a real-time data lake on AWS with rtdl and Segment. Includes steps to deploy rtdl on AWS, create an S3 bucket and configure security, and configuring both Segment and rtdl to build a real-time data lake from a source in Segment."
...
## Access your data lake with Dremio
  1.  Go to http://[EC2-Public-IP-Address]:9047 to access Dremio's web UI.  
      ![](/blog/static/images/blog/20220307-how-to-build-a-real-time-data-lake-on-aws-with-rtdl-and-segment/018.png)
  2.  Login with Username: `rtdl` and Password `rtdl1234`.
  3.  Click on your data lake in the bottom-left of the screen.  
      ![](/blog/static/images/blog/20220307-how-to-build-a-real-time-data-lake-on-aws-with-rtdl-and-segment/019.png)

From here, you can see the different types of data in your data lake – `identify`, `page`, and `track` events in this example ...  
![](/blog/static/images/blog/20220307-how-to-build-a-real-time-data-lake-on-aws-with-rtdl-and-segment/020.png)  
... Or you can navigate to the SQL Runner in the left-navigation and query your data.
![](/blog/static/images/blog/20220307-how-to-build-a-real-time-data-lake-on-aws-with-rtdl-and-segment/021.png)


That's it. Now all data generated by your source in Segment will automatically be sent to rtdl – self-hosted on AWS EC2 – and added to your real-time data lake stored on AWS S3.
